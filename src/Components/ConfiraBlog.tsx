    ...
    <div className={styles.wrapper}>
      ...
      <div id={styles.barraBlog}>
        {data.map(({ photo }:any) => {
          return (
            <>
               <div key={uuidv4()} className="d-flex justify-content-around" id={styles.blogCard}>
                <Card key={uuidv4()} style={{ width: '18rem' }}>
                  <Card.Img key={uuidv4()} variant="top" src={photo}/>
                  <Card.Body key={uuidv4()} style={{ backgroundColor: '#FEF6E7' }} >
                    <Card.Title key={uuidv4()} className={styles.boxTitulo}>Lorem ipsum dolor sit amet consectetur.</Card.Title>
                    <Card.Text key={uuidv4()} >
                    Lorem ipsum dolor sit amet, consectetur elit adipiscing dignissim posuere vitae.
                    <Button key={uuidv4()} variant="primary" className={styles.buttonEnviar}>Ler artigo</Button>
                    </Card.Text>
                  </Card.Body>
                </Card>
              </div>
